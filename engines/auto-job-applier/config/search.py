...
# PERSONA 2 - Procurement & Supplier Fulfillment Leader
# (see job-search-profiles/personas/persona-2-procurement-supplier.md)
# These are JOB TITLES, not broad skills. LinkedIn search is title-weighted, so exact
# titles pull far less noise than single words like "sourcing" or "planning".
search_terms = ["Director of Procurement", "Head of Procurement", "Senior Procurement Manager", "Strategic Sourcing Manager", "Category Manager", "Supplier Fulfillment Manager", "Materials Manager", "Supplier Performance Manager", "Purchasing Manager", "Head of Supplier Management"]
...
salary = "$120,000+"                # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"
...
# NOTE: "CNC" was removed from the default list - CNC is manufacturing/ machining, which IS on-target.
bad_words = ["US Citizen","USA Citizen","No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "React", "Angular", "TypeScript", "Kubernetes", "Frontend", "Terraform", "Machine Learning Engineer"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
...
current_experience = 15             # Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...)  # Trevor: 15+ yrs (Army 2008-2016 + corporate 2016-present)
##
