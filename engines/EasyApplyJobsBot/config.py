...
email = "tmurphy24@email.davenport.edu"
password = "LIam2016!"
...
chromeProfilePath = r"C:\Users\trevo\Desktop\.agents\EasyApplyJobsBot\chrome-profile"
...
# TODO(DECISION PENDING): Trevor has not picked a location split yet. Currently broad US/continental.
# Options: keep ["NorthAmerica"], or narrow to ["Tampa Bay Area", "Florida"] for onsite/hybrid.
location = ["NorthAmerica"]
# keywords related with your job search
# PERSONA 1 - Senior Supply Chain Executive (see job-search-profiles/personas/persona-1-supply-chain-exec.md)
# These are JOB TITLES, not broad skills. LinkedIn search is title-weighted, so exact titles
# pull far less noise than single words like "planning" or "operations".
keywords = ["Director of Supply Chain", "Supply Chain Director", "VP Supply Chain", "Head of Supply Chain", "Senior Supply Chain Manager", "Global Supply Chain Manager", "Director of Operations", "Director of Logistics", "Head of Planning", "Director of Planning"]
#job experience Level - ex:  ["Internship", "Entry level" , "Associate" , "Mid-Senior level" , "Director" , "Executive"]
# NO entry level / associate. Trevor is 15+ yrs, targeting $120k+.
...
# Contract dropped - targeting permanent leadership roles at $120k+.
...
# Staffing agencies / body shops / aggregators - they repost junk at volume.
blacklistCompanies = ["Crossover", "Jobot", "Dice", "Insight Global", "TEKsystems", "Aerotek", "Randstad", "Adecco", "Kforce", "Motion Recruitment", "Cynet", "Artech", "Collabera"]
#Blaclist keywords in title - ex:["manager", ".Net"]
# NOTE: "Associate" is deliberately NOT here - it would block good "Associate Director" roles.
blackListTitles = ["Junior", "Entry Level", "Intern", "Coordinator", "Assistant", "Apprentice", "Clerk", "Technician", "Driver", "CDL", "Software", "Developer", "Frontend", "Full Stack", "Recruiter", "Sales Representative", "Nurse", "Teacher"]
